...
Task details in [`tasks/`](tasks/) — each file is removed when completed.

- [ ] [Verify build and tests](tasks/2026-03-23-01-verify-build-and-tests.md) — confirm Go build, tests, and Docker image still work
